 ...
 * Redirects to /dashboard/executors?tab=monitor
 */
export default function MonitorPageRedirect() {
  const router = useRouter();

  useEffect(() => {
    // Redirect to executors page with monitor tab
...
/* 
 * ORIGINAL MONITOR PAGE CODE - KEPT FOR REFERENCE
 * This functionality has been merged into RealtimeMonitor component
 * Location: /src/components/executors/RealtimeMonitor.tsx
 */
