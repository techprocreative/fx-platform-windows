...
IMPORTANT: Extract the symbol from my request. If I mention a specific pair or commodity (like XAUUSD, gold, EURUSD, etc.), use that exact symbol in your response.`,
      },
    ];
    ...
    try {
      ...
      // Extract symbol from user prompt if AI didn't provide it
      let finalSymbol = strategyData.symbol;
      if (!finalSymbol) {
