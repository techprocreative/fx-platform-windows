...
class PersistenceService {
    constructor() {
        ...
        logger_1.logger.info('[PersistenceService] Initialized');
    }
    /**
    ...
    saveActiveStrategy(strategy) {
        try {
            ...
            logger_1.logger.info(`[PersistenceService] Saved strategy: ${strategy.name}`, {
                strategyId: strategy.id,
                eaAttached: strategy.eaAttached,
            });
        }
        catch (error) {
            logger_1.logger.error('[PersistenceService] Failed to save strategy:', error);
        }
    }
    /**
    ...
    removeActiveStrategy(strategyId) {
        try {
            ...
            this.store.set('lastSync', new Date().toISOString());
            logger_1.logger.info(`[PersistenceService] Removed strategy: ${strategyId}`);
        }
        catch (error) {
            logger_1.logger.error('[PersistenceService] Failed to remove strategy:', error);
        }
    }
    /**
    ...
    getActiveStrategies() {
        try {
            ...
            logger_1.logger.error('[PersistenceService] Failed to get active strategies:', error);
            return [];
        }
    }
    /**
    ...
    saveEAAttachment(attachment) {
        try {
            ...
            logger_1.logger.info(`[PersistenceService] Saved EA attachment: ${attachment.symbol} ${attachment.timeframe}`, {
                accountNumber: attachment.accountNumber,
            });
        }
        catch (error) {
            logger_1.logger.error('[PersistenceService] Failed to save EA attachment:', error);
        }
    }
    /**
    ...
    removeEAAttachment(symbol, timeframe, accountNumber) {
        try {
            ...
            logger_1.logger.info(`[PersistenceService] Removed EA attachment: ${symbol} ${timeframe}`);
        }
        catch (error) {
            logger_1.logger.error('[PersistenceService] Failed to remove EA attachment:', error);
        }
    }
    /**
    ...
    getEAAttachments() {
        try {
            ...
            logger_1.logger.error('[PersistenceService] Failed to get EA attachments:', error);
            return [];
        }
    }
    /**
    ...
    getEAAttachment(symbol, timeframe, accountNumber) {
        try {
            ...
            logger_1.logger.error('[PersistenceService] Failed to get EA attachment:', error);
            return null;
        }
    }
    /**
    ...
    updateStrategyEAState(symbol, timeframe, eaAttached, attachmentState) {
        try {
            ...
            logger_1.logger.error('[PersistenceService] Failed to update strategy EA state:', error);
        }
    }
    /**
    ...
    clearAll() {
        try {
            this.store.clear();
            logger_1.logger.info('[PersistenceService] Cleared all stored data');
        }
        catch (error) {
            logger_1.logger.error('[PersistenceService] Failed to clear data:', error);
        }
    }
    /**
     * Get last sync time
    ...
    getLastSync() {
        try {
            ...
            logger_1.logger.error('[PersistenceService] Failed to get last sync:', error);
