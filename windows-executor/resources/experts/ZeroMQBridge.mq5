...
//|                                             https://fxplatform.com |
//+------------------------------------------------------------------+
#property copyright "Copyright 2024, FX Platform Team"
#property link      "https://fxplatform.com"
...
// ZeroMQ imports (custom library)
#import "libzmq.dll"
int zmq_socket(int, int);
int zmq_ctx_new();
int zmq_connect(int, string);
int zmq_bind(int, string);
int zmq_send(int, string, int);
int zmq_recv(int, string&, int);
int zmq_close(int);
int zmq_term(int);
int zmq_setsockopt(int, int, int&, int);
int zmq_poll(int&, int, int);
int zmq_msg_init(int&);
int zmq_msg_send(int&, int, int);
int zmq_msg_recv(int&, int, int);
string zmq_msg_data(int&);
