...
export class AdvancedPositionSizingService {
    constructor() {
        Object.defineProperty(this, "DEFAULT_RISK_PERCENTAGE", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
        }); // 1%
        Object.defineProperty(this, "DEFAULT_ATR_MULTIPLIER", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1.5
        });
        Object.defineProperty(this, "KELLY_FRACTION", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.25
        }); // Use 25% of Kelly for safety
        Object.defineProperty(this, "DEFAULT_MAX_LOT", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 10.0
        });
        Object.defineProperty(this, "DEFAULT_MIN_LOT", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.01
