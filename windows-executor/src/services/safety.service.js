...
export class SafetyService extends EventEmitter {
    constructor(db) {
        ...
        Object.defineProperty(this, "emergencyConfig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "dailyTradeCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "hourlyTradeCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "lastTradeReset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Date()
        });
        Object.defineProperty(this, "lastHourReset", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Date()
        });
        Object.defineProperty(this, "emergencyStopActive", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
