...
export class StrategyService extends EventEmitter {
    constructor(apiBaseUrl, executorId, indicatorService, marketDataService) {
        ...
        Object.defineProperty(this, "strategyStates", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "evaluationIntervals", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "correlationService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "regimeDetectionService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "smartExitService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "mtfAnalysisService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
